...
const Navbar = () => {
  ...
  const isDarkHero =
    darkHeroPaths.includes(location.pathname) ||
  ...
  const linkClass = `group relative inline-flex items-center px-4 py-7 font-[Arial] text-[10px] uppercase tracking-[0.32em] ${inkText} ${hoverInk} transition-colors duration-500`;
      ...
      <div className="mx-auto max-w-[1440px] h-full px-6 md:px-10 lg:px-14">
        <div className="flex items-center justify-between h-full gap-10">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link
              to="/book-consult"
              className={`hidden lg:inline-flex items-center font-[Arial] text-[10px] uppercase tracking-[0.32em] py-2 ${inkText} ${hoverInk} transition-colors duration-500`}
            >
              Book a Consult
            </Link>
            ...
            <a
              ...
              className={`hidden lg:inline-flex items-center gap-2 px-6 py-3 font-[Arial] text-[10px] uppercase tracking-[0.32em] transition-all duration-500 ${
                overDark && !scrolled
                  ? 'text-white bg-[#1A1410] hover:bg-[#E8640A]'
                  : 'text-white bg-[#1A1410] hover:bg-[#E8640A]'
              }`}
            >
              Member Login
            ...
            <button
              ...
              className={`xl:hidden inline-flex items-center justify-center w-11 h-11 border transition-colors duration-500 ${
                overDark && !scrolled
                  ? 'border-white/25 text-white hover:bg-white hover:text-[#1A1410]'
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-7 py-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <p className="font-[Arial] text-[9px] uppercase tracking-[0.4em] text-[#E8640A]">Menu</p>
                </div>
              ...
              <div className="p-7 border-t border-[rgba(26,20,16,0.08)] bg-[#FAF6EE] space-y-3">
                ...
                >
                  Book a Consult
                  <ArrowUpRight size={14} strokeWidth={1.5} className="group-hover:translate-x-0.5 transition-transform" />
                </Link>
                <a
                  href="https://www.lmsathena.com/login"
                  target="_blank"
