        ...
        <div className="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
          <div className="grid gap-6 md:grid-cols-[1.08fr_0.92fr]">
            ...
            >
              ...
              <div className="absolute left-6 top-6 rounded-full border border-white/15 bg-black/30 px-4 py-2 lc-mc-eyebrow text-[10px] uppercase tracking-[0.32em] text-[#ff8f00] backdrop-blur-md">
            ...
            <div className="grid gap-6">
              ...
              >
                <p className="lc-mc-eyebrow text-[10px] uppercase tracking-[0.34em] text-[#ff8f00]">14+ years</p>
                <h3 className="lc-mc-card-title mt-5 text-[clamp(1.5rem,2.2vw,2.125rem)] leading-[0.98] text-white">
                  A practice rooted in fundamentals.
                </h3>
                <p className="lc-mc-body mt-4 text-[13px] leading-[1.8] text-white/68">
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <p className="lc-mc-eyebrow text-[10px] uppercase tracking-[0.34em] text-[#ff8f00]">Luke Quote</p>
                  <blockquote className="mt-5 max-w-[16ch] text-[28px] leading-[1.08] text-white">
          ...
          >
            ...
            <p className="lc-mc-body mt-7 max-w-[620px] text-[14px] leading-[1.9] text-white/72">
            ...
            <p className="lc-mc-body mt-5 max-w-[620px] text-[14px] leading-[1.9] text-white/72">
            ...
            <div className="mt-8 grid gap-px bg-white/10 sm:grid-cols-3">
              {[
                ...
                >
                  <p className="lc-mc-eyebrow text-[10px] uppercase tracking-[0.28em] text-white/58">
                    {item}
                  </p>
                </motion.div>
              ))}
