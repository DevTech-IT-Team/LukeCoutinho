  ...
  return (
    <section id={id} className="bg-[#FAF6EE] border-y border-[rgba(26,20,16,0.08)] scroll-mt-24">
      <div className="mx-auto max-w-[720px] px-6 md:px-10 py-16 lg:py-20">
        <p className="lc-mc-eyebrow text-[10px] uppercase tracking-[0.35em] text-[#ff8f00] mb-4 text-left">
          Save your spot
        </p>
        <h2 className="text-[clamp(28px,4vw,40px)] leading-[1.05] text-[#1a3c34] mb-3 text-left">
          Reserve your seat
        </h2>
        <p className="lc-mc-body text-[14px] leading-[1.85] text-[rgba(26,20,16,0.65)] mb-8 text-left max-w-[52ch]">
