  ...
  return (
    <>
      ...
      <section className="border-b border-[rgba(26,20,16,0.08)] bg-[#FDFAF5]">
        <div className="mx-auto max-w-[1440px] px-6 py-20 md:px-10 lg:px-16 lg:py-24">
          <EditorialMasthead
            eyebrow="A Smarter Way To Learn"
            title="Less noise."
            titleAccent="More usable wisdom."
          >
            <p>
              These live sessions break down health topics into essentials you can understand, implement, and sustain
              without overwhelm.
            </p>
            <p>
