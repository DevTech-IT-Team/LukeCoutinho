				...
				<div className="flex items-center justify-between h-full gap-10">
					...
					<div className="flex items-center gap-3 shrink-0">
						...
						<a
							...
							className="hidden lg:inline-flex items-center gap-2 px-6 py-3 font-[Arial] text-[10px] uppercase tracking-[0.32em] text-white bg-[#1A1410] hover:bg-[#E8640A] transition-all duration-500"
						>
							Member Login
						...
						<button
							...
							className="xl:hidden inline-flex items-center justify-center w-11 h-11 border border-[rgba(26,20,16,0.15)] text-[#1A1410] hover:bg-[#1A1410] hover:text-white transition-colors duration-500"
						>
