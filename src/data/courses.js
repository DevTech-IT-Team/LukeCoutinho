...
const courses = [
  ...
  {
    id: 'foundations-metabolic-health',
    title: 'Foundations of Metabolic Health',
    subtitle: 'Build energy with metabolism-first nutrition',
    category: 'Nutrition',
    summary:
      'A practical foundation for metabolic balance, combining food, movement and daily rhythm to reduce acidity, stabilise blood sugar and support vitality.',
    level: 'Beginner',
    lessons: 10,
    duration: '6 Hours',
    price: '₹749',
    ...
    includes: DEFAULT_INCLUDES,
    learn: [
      'Insulin stability and mitochondrial support',
      'Acidity-balancing meal sequences',
      'Movement, rest and stress support',
      'Protocols for daily metabolic resilience',
    ],
    curriculum: [
      { title: 'Metabolic Foundations', length: '40 min' },
      { title: 'Stabilising Energy', length: '60 min' },
      { title: 'Meal & Movement Rhythm', length: '70 min' },
      { title: 'Putting the Protocol Together', length: '50 min' },
    ],
  },
  {
    id: '21-day-gut-reset',
  ...
  {
    id: 'gut-health-acidity-constipation',
    title: 'Gut Health – Managing Acidity & Constipation',
    subtitle: 'Restore digestion, soothe acidity and improve bowel comfort',
    category: 'Healing',
    summary:
      'A focused gut protocol to calm acid reflux, normalize bowel function and rebuild digestive resilience with gentle food and lifestyle shifts.',
    level: 'Intermediate',
    lessons: 12,
    duration: '5 Weeks',
    price: '₹799',
    ...
    includes: DEFAULT_INCLUDES,
    learn: [
      'Understanding gut acidity and motility',
      'Tolerance-building food plans',
      'Breath, stress and digestion protocols',
      'Bowel regularity without harsh laxatives',
    ],
    curriculum: [
      { title: 'Acidity & Digestion Basics', length: '45 min' },
      { title: 'Repairing the Gut Lining', length: '60 min' },
      { title: 'Improving Motility Safely', length: '60 min' },
      { title: 'Maintenance & Long-term Comfort', length: '50 min' },
    ],
  },
  {
  ...
  {
    id: 'immunity-lymphatic-health',
    title: 'Strengthening Immunity with Lymphatic Health',
    subtitle: 'Deep lymphatic support for a resilient immune system',
    category: 'Healing',
    summary:
      'Learn how to support immunity through the lymphatic system with movement, hydration, nutrition and self-care designed to reduce congestion and strengthen defense.',
    level: 'Intermediate',
    lessons: 14,
    duration: '8 Weeks',
    price: '₹849',
    ...
    includes: DEFAULT_INCLUDES,
    learn: [
      'Lymphatic circulation and immune integration',
      'Daily drainage habits and movement sequences',
      'Nutrition to support lymphatic flow',
      'Managing inflammation through the immune lens',
    ],
    curriculum: [
      { title: 'Lymphatic Basics', length: '40 min' },
      { title: 'Flow & Drainage Protocol', length: '90 min' },
      { title: 'Immune Support Nutrition', length: '60 min' },
      { title: 'Sustaining Resilience', length: '60 min' },
    ],
  },
];
